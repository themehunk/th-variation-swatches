...
class TH_Variation_Swatches_Notice{
    ...
    function th_variation_swatches_admin_notice() { 
      ...
      if(isset($_GET['ntc-vrtn-disable'])){
    ...
    <div class="th-variation-swatches-notice notice" style="display:<?php echo esc_attr($display); ?>;">
    ...
    function th_variation_swatches_notice_unset_cookie(){
            ...
            $cookie_time = isset($_COOKIE['thntc_vrtn_time']) ? sanitize_key($_COOKIE['thntc_vrtn_time']) : '0';
